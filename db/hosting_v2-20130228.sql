...
AVG_ROW_LENGTH=16384 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
INSERT INTO `accounts` (`id`, `user_id`, `account_name`, `account_description`, `account_password`, `uid`, `gid`, `home_dir`, `shell`, `count`, `accessed`, `modified`, `expired`, `status`, `is_delete`) VALUES
  ...
  (14,9,'hustariz','Pagian personal del Lic Hernan Ustariz para l amateria de Inf145(Introducciu00f3n a la programaciu00f3n - Computaciu00f3n I)<br>','hpscan5590jeT',2000,2000,'/srv/hustariz','/sbin/nologin',0,'0000-00-00 00:00:00','2013-02-27 23:17:46','2013-02-27 23:17:45','expired',0);
COMMIT;

#
# Data for the `accounts_servers` table  (LIMIT -498,500)
#
...
#
# Data for the `quota_limits` table  (LIMIT -497,500)
#
...
INSERT INTO `quota_limits` (`id`, `account_id`, `account_name`, `quota_type`, `per_session`, `limit_type`, `bytes_in_avail`, `bytes_out_avail`, `bytes_xfer_avail`, `files_in_avail`, `files_out_avail`, `files_xfer_avail`) VALUES
  ...
  (2,14,'hustariz','user','false','soft',104857600,0,0,0,0,0);
COMMIT;
...
INSERT INTO `users` (`id`, `user_name`, `title`, `first_name`, `last_name`, `email`, `phone`, `created`, `modified`, `status`, `photo`, `is_delete`) VALUES
  ...
  (9,'hustariz','Lic','Hernan','Ustariz','hustariz@cs.umss.edu.bo',70727734,'2013-01-27','2013-02-27 23:17:46',1,NULL,0);
COMMIT;
