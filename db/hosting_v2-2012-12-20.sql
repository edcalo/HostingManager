...
INSERT INTO `users` (`id`, `user_name`, `first_name`, `last_name`, `email`, `created`, `modified`, `status`, `photo`, `is_delete`) VALUES

  (1,NULL,'elvis','caceres','edcalo@gmail.com','2012-12-17','2012-12-17 00:00:00',1,NULL,0);
COMMIT;
